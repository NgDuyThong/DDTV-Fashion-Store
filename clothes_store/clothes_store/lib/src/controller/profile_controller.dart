...
class ProfileController {
  ...
  Future<ReturnMessage> changePassword(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return ReturnMessage(
            statusCode: response.statusCode, message: jsonData['message']);
      } else {
        return ReturnMessage(
  ...
  Future<ReturnMessage> updateProfile(
  ...
  Future<ReturnMessage> addAddress(String address) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return ReturnMessage(
            statusCode: response.statusCode, message: 'Failed to add address');
      }
    } catch (e) {
      return ReturnMessage(statusCode: 500, message: 'Error: $e');
    }
  ...
  Future<ReturnMessage> updateAddress(
      int id, String address, bool isDefault) async {
