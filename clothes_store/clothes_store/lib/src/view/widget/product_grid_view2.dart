...
class ProductGridView2 extends StatelessWidget {
  ...
  Widget _buildProductCard(PRODUCT_MODEL product, BuildContext context) {
    String originalPrice = NumberFormat.currency(locale: 'vi_VN', symbol: 'VNĐ')
        .format(product.price);
    String? discountedPrice;

    if (product.promotion != null &&
        product.promotion!.discountedPrice != null &&
        product.promotion!.discountedPrice! > 0) {
      ...
      return Padding(
        ...
        child: GridView.builder(
          ...
          itemBuilder: (context, index) =>
              _buildProductCard(items[index], context),
        ),
      );
    } else {
      return Center(
