    ...
    try {
      ...
      if (mounted) {
        showSnackBar(context,
            "Có lỗi xảy ra khi tải giỏ hàng. Vui lòng thử lại sau", Colors.red);
      }
    }
  }
                          ...
                          IconButton(
                            onPressed: () async {
                              ...
                              if (currentStock != null &&
                                ...
                                showSnackBar(context, 'Sản phẩm đã đạt tối đa',
                                    Colors.red);
                              }
                            },
            ...
            child: ElevatedButton(
              onPressed: items!.isEmpty
                  ...
                  : () {
                      if (skuList.isEmpty) {
                        showSnackBar(
                            context, "Vui lòng chọn sản phẩm", Colors.red);
                      } else {
                        cartItemsToOrder =
