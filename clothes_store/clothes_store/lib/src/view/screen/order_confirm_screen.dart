...
class _OrderConfirmPageState extends State<OrderConfirmPage> {
  ...
  double priceAfterDiscountCalculate(double oldPrice, int categoryID) {
      ...
      if (itemApplicable) {
        if (_selectedCoupon!.couponInfo!.discountType == 'percentage') {
          totalExpectedDiscount +=
              (itemTotal * _selectedCoupon!.couponInfo!.discountValue!) / 100;
        } else {
          totalExpectedDiscount +=
              _selectedCoupon!.couponInfo!.discountValue!.toDouble();
        }
      }
    }
    ...
    double maxDiscountAmount =
        _selectedCoupon!.couponInfo!.maxDiscountAmount?.toDouble() ??
            double.infinity;
    ...
    if (_selectedCoupon!.couponInfo!.discountType == 'percentage') {
      discountAmount =
          (oldPrice * _selectedCoupon!.couponInfo!.discountValue!) / 100;
    } else {
  ...
  Future<void> _createOrder() async {
    ...
    final success = await orderController.createOrder(
      ...
      address:
          _useNewAddress ? _addressController.text : _selectedAddress!.address!,
                        ...
                        if (_addresses.isNotEmpty) ...[
                          Container(
                            ...
                            child: DropdownButtonFormField<ADDRESS_MODEL>(
                              ...
                              items: _addresses
                                  .map((addr) =>
                                      DropdownMenuItem<ADDRESS_MODEL>(
                                        value: addr,
                                        child: Container(
                    ...
                    _buildSection(
                      ...
                      child: Container(
                        ...
                        child: DropdownButtonFormField<UserCoupons>(
                          ...
                          isDense: false,
                          items: _coupons
                              .map((coupon) => DropdownMenuItem<UserCoupons>(
                                    value: coupon,
                                    child: Container(
                                      padding: const EdgeInsets.symmetric(
                                          vertical: 12),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                fontSize: 16,
                                decoration: paymentPrice < widget.totalPrice
                                    ? TextDecoration.lineThrough
                                    : null,
                                color: paymentPrice < widget.totalPrice
                                    ? Colors.grey
                                    : Colors.black,
                              ),
                            ),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                NumberFormat.currency(
                                        locale: 'vi_VN', symbol: 'đ')
                                    .format(widget.totalPrice - paymentPrice),
                                style: const TextStyle(
                                  fontSize: 14,
                                  color: Colors.green,
                                  fontWeight: FontWeight.bold,
