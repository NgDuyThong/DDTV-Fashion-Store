                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            if (fullnameCon.text.isEmpty&&
                                ...
                                passwordVerifyCon.text.isEmpty &&
                                phoneCon.text.isEmpty) {
                              showSnackBar(context,
                                  "Vui lòng nhập đầy đủ thông tin", Colors.red);
                            } else if (fullnameCon.text.isEmpty) {
                              showSnackBar(context, "Vui lòng nhập fullname",
                                  Colors.red);
                            } else if (emailCon.text.isEmpty) {
                              showSnackBar(
                                  context, "Vui lòng nhập email", Colors.red);
                            } else if (passwordCon.text.isEmpty) {
                              showSnackBar(context, "Vui lòng nhập password",
                                  Colors.red);
                            } else if (passwordVerifyCon.text.isEmpty) {
                              showSnackBar(context,
                                  "Vui lòng nhập password verify", Colors.red);
                            } else if (phoneCon.text.isEmpty) {
                              showSnackBar(
                                  context, "Vui lòng nhập phone", Colors.red);
                            } else if (passwordCon.text !=
                                passwordVerifyCon.text) {
                              showSnackBar(
                                  context,
                                  "Password và password verify không khớp",
                                  Colors.red);
                            } else {
                              userSignup();
                            }
