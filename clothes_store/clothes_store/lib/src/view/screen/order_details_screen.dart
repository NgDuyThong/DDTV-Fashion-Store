...
class _OrderDetailScreenState extends State<OrderDetailScreen> {
  ...
  Widget _buildOrderStatusCard() {
    ...
    final shippingStatusColor =
        _getShippingStatusColor(_order?.shippingStatus ?? '');
    final shippingStatusText =
        _getShippingStatusText(_order?.shippingStatus ?? '');
    final shippingStatusIcon =
        _getShippingStatusIcon(_order?.shippingStatus ?? '');
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Giá: ${_convertToVNCurrency(detail.product!.price! * 1000)}',
                      style: TextStyle(
                        color: Colors.grey[600],
                        fontSize: 14,
                      ),
