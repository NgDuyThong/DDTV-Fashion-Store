...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  Future<void> addToCart() async {
    ...
    String maSKU = widget
        .product.colors![colorChoosingIndex].sizes![sizeChoosingIndex].sKU!;
    print("maSKU = $maSKU");
    try {
  ...
  Future<void> addToFavorite() async {
    ...
    try {
      ...
      showSnackBar(context, data.messager ?? 'Có lỗi xảy ra',
  ...
  Future<void> getRelatedProducts() async {
    try {
      final data = await controller.getRelatedProducts(
          widget.product.categoryID, widget.product.targetID);
      ...
      child: Row(
        children: [
          Column(
            ...
            children: [
              Text(
                (widget.product.promotion != null &&
                        widget.product.promotion!.discountedPrice! > 0
                    ? NumberFormat.currency(locale: 'vi_VN', symbol: 'VNĐ')
                        .format(widget.product.promotion!.discountedPrice!)
                    : NumberFormat.currency(locale: 'vi_VN', symbol: 'VNĐ')
      ...
      children: [
        Expanded(
          child: ElevatedButton.icon(
            ...
            label:
                const Text("Yêu thích", style: TextStyle(color: Colors.white)),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: GetBuilder<ProductController>(
                              builder: (_) =>
                                  productSizesListView(colorChoosingIndex),
                            ),
                          ),
                          const SizedBox(height: 24),
                          Text(
